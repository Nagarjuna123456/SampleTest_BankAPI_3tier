using BankAPISample.Repository.Repository;
...
namespace BankAPISample
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BankAPIContext>(options => options.UseSqlServer(Configuration["ConnectionStrings:BankAPIConnection"]));
